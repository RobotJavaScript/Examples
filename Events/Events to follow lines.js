/*  Line Following Using Events (make sure you have read the Overview for Line Following in the Examples: Line Following section)
...
function toFollowLine(event) {           // The event object is passed as a parameter into the handler function.  This variable is often identified as 'e' or 'event'
  if(!somethingThere) {                  // IF there is NOT something in front of the robot, THEN do line following.  The exclamation point symbol reverses the value of the boolean variable in the expression.
